        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-400 mb-4 text-sm">
              ...
              We specialize in helping clients buy, sell, and rent properties in
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  123 Property Street, Real Estate City, 10001
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-400">info@sahandestate.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-gray-400 mr-3 mt-1"
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400 mb-4 md:mb-0">
              © {currentYear} Sahand Estate. All rights reserved.
            </p>
